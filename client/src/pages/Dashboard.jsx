    ...
    <div className="flex h-screen bg-slate-950 font-sans overflow-hidden">
      ...
      <aside className="w-64 border-r border-slate-800/50 bg-slate-900/50 backdrop-blur-xl flex flex-col relative z-20">
        <div className="p-6 border-b border-slate-800/50">
          ...
          <p className="text-xs text-slate-500 mt-1 uppercase tracking-wider font-semibold">P2P Lending</p>
        </div>
        <nav className="flex-1 p-4 space-y-2">
          <a href="#" className="flex items-center px-4 py-3 bg-indigo-500/10 text-indigo-400 rounded-xl transition-all font-medium border border-indigo-500/20">
          ...
          <a href="#" className="flex items-center px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 rounded-xl transition-all font-medium">
      ...
      <main className="flex-1 flex flex-col relative z-10 overflow-y-auto">
        ...
        <header className="h-16 border-b border-slate-800/50 bg-slate-900/30 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-30">
          <h2 className="text-xl font-semibold text-white tracking-tight">Welcome back, {user?.name || 'User'} 👋</h2>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900/50 border border-slate-800/50 p-6 rounded-2xl shadow-xl backdrop-blur-sm relative overflow-hidden group hover:border-purple-500/30 transition-colors">
              ...
              <p className="text-slate-400 text-sm font-medium">Active Investments</p>
            ...
            <div className="bg-slate-900/50 border border-slate-800/50 p-6 rounded-2xl shadow-xl backdrop-blur-sm relative overflow-hidden group hover:border-blue-500/30 transition-colors">
              ...
              <p className="text-slate-400 text-sm font-medium">Pending Returns</p>
              <h3 className="text-3xl font-bold text-white mt-2">$0.00</h3>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800/50 rounded-2xl shadow-xl backdrop-blur-sm overflow-hidden flex flex-col items-center justify-center p-16 border-dashed">
            ...
            <h4 className="text-lg font-medium text-slate-300">No active loans yet</h4>
            <p className="text-slate-500 text-sm mt-1 max-w-sm text-center">Your active portfolio and marketplace opportunities will appear here once the loan endpoints are connected in Phase 2.</p>
          </div>
