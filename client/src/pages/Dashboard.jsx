      ...
      <main className="flex-1 flex flex-col relative z-10 overflow-y-auto">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="bg-slate-900/50 border border-slate-800/50 p-6 rounded-2xl shadow-xl backdrop-blur-sm relative overflow-hidden group hover:border-emerald-500/30 transition-colors">
            ...
            {/* Next Payout Date */}
            <div className="bg-slate-900/50 border border-slate-800/50 p-6 rounded-2xl shadow-xl backdrop-blur-sm relative overflow-hidden group hover:border-pink-500/30 transition-colors">

              <div className="absolute -right-6 -top-6 w-24 h-24 bg-pink-500/10 rounded-full group-hover:scale-150 transition-transform duration-500 ease-out"></div>
